...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:ifRs/oHByR6NfEXfusvjoTqX/KcSvDYNFASoK/wXKfs=",
        version = "v1.6.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:pHQfb4jh9iKqHyxPthq1fr+0HwSNIl3btYPbw2m2lbM=",
        version = "v1.4.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:aqUSOcStk6fik+lSE+tqfFhvt/EwT8q/oMtJbP9CjXI=",
        version = "v4.7.1",
    )
    go_repository(
